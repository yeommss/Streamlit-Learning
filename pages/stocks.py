...
selected_year = st.sidebar.selectbox(
    'Year', list(reversed(range(2010, thisyear+1))))
...
# 첫번째가 선택될 열
# 두번째는 선택되어진 열 (들어가면 바로 보이는 화면)
selected_chart = st.sidebar.multiselect(
    'display chart', display_chart, display_chart)
...
# plotly 간단하게 넣으려면 이렇게
# 따로 st.plotly_chart() 라는 api가 있음.
